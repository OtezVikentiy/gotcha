...
func TestMigrationStagesAreLogged(t *testing.T) {
	...
	// Сравниваем позиции вхождений, а не только Contains — иначе не отличить
	// верный порядок строк от переставленных местами.
	...
	// Длительность — в поле duration, не в тексте: её читают машины.
