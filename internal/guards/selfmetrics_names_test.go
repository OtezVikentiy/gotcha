...
var wantSelfMetrics = []selfMetricSpec{
	...
	{"gotcha_escalation_scheduler_skipped_incidents", "Gauge"},
	...
	{"gotcha_host_evaluator_skipped_hosts", "Gauge"},
	...
	{"gotcha_metric_evaluator_skipped_rules", "Gauge"},
