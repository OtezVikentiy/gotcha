...
// Кандидаты берём только из кода в markdown — проза даёт обрывки и чужие адреса.
// Класс символов включает `<>?#`, чтобы захватить плейсхолдеры и query-строку целиком перед нормализацией.
var (
