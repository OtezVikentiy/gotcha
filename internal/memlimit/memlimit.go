...
// буферы всех писателей теряются целиком (события, спаны, метрики, профили,
// логи).
//
...
//
// Остаток — запас на стеки горутин, аллокации вне кучи и сам рантайм. Потолок
// кучи, равный лимиту контейнера, не защищает ни от чего: превысить его
// означает быть убитым. Значение 0.8 замерено на боевом VPS 2 ядра / 2 ГБ при
// подготовке стеснённого профиля docker-compose.small.yml.
