...
// Штатный генератор goldmark даёт кириллическому заголовку якорь вида
// «heading-3» — привязанный к порядку разделов, а не к тексту заголовка.
...
// Практическая транслитерация, а не стандарт — якорь должен быть узнаваем в адресной строке.
