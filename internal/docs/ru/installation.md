...
- **Linux-сервер** (VPS/выделенный сервер) — подойдёт Ubuntu 22.04/24.04 или Debian 12, минимум 2 ГБ RAM (Gotcha одновременно поднимает три процесса: само приложение, PostgreSQL и ClickHouse).
