...
- **Retries** — сколько раз повторить одну провалившуюся проверку, прежде чем засчитать её как неуспех (0–10). Гасит кратковременный сбой (потерянный пакет, короткий сбой TLS), чтобы он не переводил монитор в down и не открывал инцидент.
