...
Администратор инстанса настраивает и удаляет [SSO](/docs/sso) организаций — эта возможность не выдаётся ролью owner, только этим флагом (см. таблицу ролей выше). Аккаунт администратора инстанса нельзя удалить, пока роль не передана другому пользователю.
...
| [Подавление шторма](/docs/alert-suppression): рёбра зависимостей — создание, удаление | — | ✓ | ✓ | ✓ |
