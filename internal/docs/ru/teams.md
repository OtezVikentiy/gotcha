...
| Роль | Что может |
|---|---|
| **owner** (владелец) | Всё, что может admin, плюс: назначать/снимать роль owner у других, удалять owner'ов, видеть раздел [SSO](/docs/sso) организации (саму настройку, помимо роли owner, разрешает только отметка «администратор инстанса»), выгрузка/удаление персональных данных субъектов (152-ФЗ), удаление организации целиком |
...
| Каналы оповещений: создание, правка, удаление, «Проверить» | — | — (видит только тип канала и замаскированную цель — этого хватает, чтобы выбрать канал в правиле) | ✓ | ✓ |
