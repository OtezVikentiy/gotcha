...
заметно превышающая `GOTCHA_METRIC_EVAL_INTERVAL` (по умолчанию 60с), означает,
...
`GOTCHA_PROFILE_EVAL_INTERVAL` (по умолчанию 300с), означает, что алерты по
...
заметно превышающая `GOTCHA_ESCALATION_INTERVAL` (по умолчанию 60с), означает,
