...
значит содержит и шаги установки СУБД) и код завершения, повторный запуск с теми же
флагами идемпотентен — не переделывает уже сделанное и продолжает с отказавшего шага.
