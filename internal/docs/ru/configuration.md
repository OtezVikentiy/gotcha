...
| Переменная | По умолчанию | Описание |
|---|---|---|
| `GOTCHA_RETENTION_DAYS` | `90` | Хранение событий (ошибок), транзакций и Web Vitals, а также сводных записей в PostgreSQL: групп, закрытых инцидентов и регрессий (см. [Приватность](/docs/privacy)). `0` отключает удаление. |
