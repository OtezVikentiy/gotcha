...
| **OpenCart** 4.x | [gotcha (ocmod)](https://getgotcha.ru/downloads/opencart-gotcha-1.0.0.ocmod.zip) | PHP errors (handler chain), transactions by route (`product/product`), JS errors and Web Vitals |
