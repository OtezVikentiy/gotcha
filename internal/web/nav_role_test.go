...
// оповещений требуют owner/admin. Навигация показывала их всем ролям: человек
// тыкал в пункт, нарисованный самим продуктом, и попадал на «страницы нет».
// Туда же вела ссылка «Настройки приёма» из баннера квоты.
