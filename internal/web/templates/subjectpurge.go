...
type SubjectPurgeVM struct {
	// Projects — проекты организации для выбора селектом. Раньше номер проекта
	// вводился числом вручную, а списка проектов на странице настроек нет
	// вовсе: владелец добывал id из адресной строки другого раздела. Оттуда же
	// росла и главная опасность формы — опечатка 25→26 необратимо чистила
	// телеметрию соседнего проекта.
...
// ProjectOption — проект в селекте форм по ПДн.
