...
func pageComponents() map[string]templ.Component {
	...
	m := map[string]templ.Component{
		...
		"Alerts":               Alerts(7, []alert.Rule{{ID: 1, Kind: alert.KindNewIssue, Enabled: true}, {ID: 2, Kind: alert.KindSpike, Enabled: false, Threshold: 10, WindowMinutes: 5}}, []alert.Channel{{ID: 1, Kind: "email", Enabled: true, Target: "t@x.io"}, {ID: 2, Kind: "telegram", Enabled: false, Target: "@ch"}}, true, nil, "err", "u@e.com"),
