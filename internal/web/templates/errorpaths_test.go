...
func pageComponents() map[string]templ.Component {
	...
	m := map[string]templ.Component{
		...
		"StatusPagesSet":       StatusPagesSettings(7, "https://g.example", []StatusPageForm{{ID: 1, Slug: "p", Title: "T", Description: "d", Enabled: true, Monitors: []StatusPageFormMonitor{{ID: 10, MonitorName: "web", Selected: true, DisplayName: "W"}, {ID: 20, MonitorName: "api"}}}}, StatusPageForm{Monitors: []StatusPageFormMonitor{{ID: 10, MonitorName: "web"}}}, true, "err", "u@e.com"),
