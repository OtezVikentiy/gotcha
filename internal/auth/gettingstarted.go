...
// Флаг живёт в профиле, а не в cookie: скрытое не должно воскресать на другом устройстве.
...
// Обратной ручки нет намеренно: «Скрыть» — необратимое решение, не переключатель.
